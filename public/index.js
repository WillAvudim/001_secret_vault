...
/*global
_ Vue $ global_render_registry Decrypt Encrypt
*/
...
// ==========================================================
// Chrome's synced file system.
// ==========================================================
$(function () {
  console.error("TODO: implement sync!");
  // Per instructions in https://github.com/dropbox/dropbox-sdk-js
  ...
  //        fs.root.getFile('info.txt', {create:true}, function(content) {console.log(content)}, function(error) {console.log(error)});
  //     });
});
